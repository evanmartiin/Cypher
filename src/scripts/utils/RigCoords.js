...
class RigCoords {
	...
	update() {
		...
		this.leftWristSpeed.value += (this.leftWristDiff.length() * 30 - this.leftWristSpeed.value) * 0.02;
		...
		this.rightWristSpeed.value += (this.rightWristDiff.length() * 30 - this.rightWristSpeed.value) * 0.02;
		...
		this.leftFootSpeed.value += (this.leftFootDiff.length() * 30 - this.leftFootSpeed.value) * 0.02;
		...
		this.rightFootSpeed.value += (this.rightFootDiff.length() * 30 - this.rightFootSpeed.value) * 0.02;
	}
}
